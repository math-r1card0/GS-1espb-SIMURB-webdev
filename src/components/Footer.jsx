        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-2xl font-bold text-white">SIMURB</span>
            </div>
            <p className="text-gray-300 text-base max-w-md">
              Sistema Inteligente de Monitoramento Urbano - Transformando cidades em espaços mais inteligentes e sustentáveis.
            </p>
          ...
          <div className="md:flex md:items-center md:justify-between">
            <div className="flex space-x-6 md:order-2">
              <p className="text-gray-400 text-sm">
                Desenvolvido por estudantes FIAP
              </p>
            </div>
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; {currentYear} SIMURB. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </div>
