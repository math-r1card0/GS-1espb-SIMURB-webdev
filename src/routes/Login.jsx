...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <Helmet>
        <title>Login - SIMURB</title>
        <meta name="description" content="Faça login na plataforma SIMURB para acessar o sistema de monitoramento urbano inteligente." />
      </Helmet>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <button
                  type="button"
                  className="font-medium text-primary-600 hover:text-primary-500 transition-colors duration-200 bg-transparent border-none cursor-pointer underline"
                  onClick={() => alert('Funcionalidade de recuperação de senha será implementada')}
                >
                  Esqueceu a senha?
                </button>
              </div>
